...
namespace FM_Rozetka_Api.Infrastructure.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_CountryProductionProducts_CountryProductionProduct~",
                        column: x => x.CountryProductionProductId,
                        principalTable: "CountryProductionProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_CountryProductionProductId",
                table: "Products",
                column: "CountryProductionProductId",
                unique: true);
