...
namespace FM_Rozetka_Api.Core.Services
{
    internal class ProductQuestionService : IProductQuestionService
    {
        ...
        public async Task<ServiceResponse<IEnumerable<ProductQuestionDTO>, object>> GetActiveQuestions(int shopId)
        {
            try
            {
                var questions = (await _productQuestionRepository.GetListBySpec(
                    new ProductQuestionSpecification.OpenQuestionsByShopId(shopId))
                ).ToList();
